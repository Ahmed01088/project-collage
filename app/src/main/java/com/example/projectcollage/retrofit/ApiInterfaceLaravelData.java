...
public interface ApiInterfaceLaravelData {
    ...
    @GET("realtime/livestrated/{classroom_id}")
    ...
    Call<Data<Chat>> deleteChatById(@Path("id") int id);
    //=================================================================
    //=================================Quiz============================
    //=================================================================
    @GET("quiz/all")
    ...
    //================================== realtime ======================
    @POST("realtime/updateStatus/{student_id}/{is_online}")
    Call<Data<Realtime>> updateStatus(@Path("student_id") int student_id, @Path("is_online") int is_online);

    @POST("realtime/isQuizStarted/{student_id}/{is_quiz_started}")
    Call<Data<Realtime>> startQuiz(@Path("student_id") int student_id, @Path("is_quiz_started") int is_quiz_started);

    @POST("realtime/finishLive/{student_id}/{is_live}")
    Call<Data<Realtime>> finishLive(@Path("student_id") int student_id, @Path("is_live") int is_live);

    @GET("realtime/isLive/{student_id}")
    Call<Data<Realtime>> getIsLive(@Path("student_id") int student_id);

    @GET("realtime/isQuizStarted/{student_id}")
    Call<Data<Realtime>> getIsQuizStarted(@Path("student_id") int student_id);

    @GET("realtime/isOnline/{student_id}")
    Call<Data<Realtime>> getIsOnline(@Path("student_id") int student_id);

    @GET("realtime/finishLive/{classroom_id}")
    Call<Data<Realtime>> getFinishLive(@Path("classroom_id") int classroom_id);

    @GET("realtime/push-quiz/{quiz_id}")
